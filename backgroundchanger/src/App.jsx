  ...
  return (
    <div className='w-full h-screen duration-200'
      ...
      bottom-12 inset-x-0 px-2'>
        ...
        gap-3 shadow-lg bg-slate-100  px-3 py-2 rounded-xl'>
          <button 
          ...
          rounded-full text-black
           shadow-lg 'style={{ backgroundColor: 'white' }} >White</button>
          <button 
          ...
          className='outline-none px-4 py-1, 
          rounded-full text-black
           shadow-lg 'style={{ backgroundColor: 'Aqua' }} >Aqua</button>
          <button 
          ...
          rounded-full text-white
           shadow-lg 'style={{ backgroundColor: 'purple' }} >Purple</button>
            ...
            className='outline-none px-4 py-1, 
          rounded-full text-black
           shadow-lg 'style={{backgroundColor: 'lavender'}} >Lavender</button>
            <button 
          ...
          rounded-full text-black
           shadow-lg 'style={{backgroundColor: 'pink'}} >Pink</button>
            ...
            className='outline-none px-4 py-1, 
          rounded-full text-white
           shadow-lg 'style={{backgroundColor: 'gray'}} >Grey</button>
            <button 
            onClick={()=> setColor("aquamarine")}
            className='outline-none px-4 py-1, 
          rounded-full text-black
           shadow-lg 'style={{backgroundColor: 'aquamarine'}} >Aqua-Marine</button>
        </div>
      </div>
    </div>
  )
